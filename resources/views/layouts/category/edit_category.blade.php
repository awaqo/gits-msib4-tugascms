...
@section('content')
    <div class="p-12">
        <div class="flex items-center gap-3">
            <a href="{{ route('view.category') }}" class="text-white font-medium bg-yellow-500 py-2 px-5 rounded-lg hover:opacity-80 duration-300"><i class="fa-solid fa-arrow-left"></i> Back</a>
            <div class="text-2xl">Form Edit Kategori</div>
        </div>
        <div class="max-w-xl">
            <form class="space-y-6" action="{{ url('category/'.$categories->id) }}" method="POST">
                @method('PUT')
                @csrf
                <div>
