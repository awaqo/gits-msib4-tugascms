...
@section('content')
    <div class="px-12 py-6">
        ...
        <div class="w-full mt-8">
            <a href="{{ route('form.category') }}" class="text-white font-medium bg-blue-500 py-3 px-6 rounded-lg hover:opacity-80 duration-300">+ Tambah Kategori</a>
        </div>
                            ...
                            <tr class="divide-x bg-white border-b hover:bg-gray-100">
                                ...
                                <td class="w-32 px-6 py-4">
                                    <div class="flex items-center space-x-2">
                                        <a href="{{ url('category/' . $item->id . '/edit') }}" class="py-2 px-3 rounded-md text-white bg-yellow-500 hover:bg-yellow-600" data-tooltip-target="tooltip-edit" data-tooltip-style="light">
