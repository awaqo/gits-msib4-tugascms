...
@section('content')
    <div class="p-12">
        <a href="{{ route('view.product') }}" class="text-white font-medium bg-yellow-500 py-2 px-5 rounded-lg hover:opacity-80 duration-300"><i class="fa-solid fa-arrow-left"></i> Back</a>
        <a href="{{ url('product/' . $products->id . '/edit') }}" class="text-white font-medium bg-green-600 py-2 px-5 rounded-lg hover:opacity-80 duration-300"><i class="fa-solid fa-edit"></i> Edit</a>
            ...
            <div class="grid gap-6 mb-6 md:grid-cols-2">
                ...
                <div class="space-y-4">
                    ...
                    <div class="overflow-hidden rounded-lg">
                        <img src="{{ asset('storage/images/products/' . $products->image) }}" alt="Gambar {{ $products->name }}">
                    </div>
                </div>
            </div>
        </div>
