...
@section('content')
    <div class="px-12 py-6">
        ...
        <div class="w-full mt-8">
            <a href="{{ route('form.product') }}" class="text-white font-medium bg-blue-500 py-3 px-6 rounded-lg hover:opacity-80 duration-300">+ Tambah Produk</a>
        </div>
        ...
        <div class="text-2xl font-bold mt-10">List Produk</div>
        <div class="relative overflow-x-auto shadow-lg sm:rounded-sm mt-5">
            <table class="w-full text-sm text-left text-gray-600">
                <thead class="text-xs text-gray-800 uppercase bg-blue-300">
                    <tr class="divide-x">
                ...
                <tbody>
                    @if ($products->count() < 1)
                        <tr>
                            <td colspan="8" class="py-4 px-6 text-center text-lg font-semibold">Belum ada produk</td>
                        </tr>
                    @else
                            ...
                            <tr class="divide-x bg-white border-b hover:bg-gray-100">
                                ...
                                <td class="w-32 px-6 py-4">
                                    <div class="flex items-center space-x-2">
                                        <a href="{{ url('product/' . $item->id . '/show') }}"
                                        ...
                                        <a href="{{ url('product/' . $item->id . '/edit') }}" class="py-2 px-3 rounded-md text-white bg-yellow-500 hover:bg-yellow-600" data-tooltip-target="tooltip-edit" data-tooltip-style="light">
